...
class Inchoo_FeaturedProducts_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct() {
        ...
        $this->setCheckboxCheckCallback('FeaturedCheckboxCheck');
    }
    ...
    protected function _prepareCollection() {
        ...
        if ($action_name == 'exportCsv' || $action_name == 'exportXml') {
            $collection->addAttributeToFilter('inchoo_featured_product', array('eq' => true));
        }
    ...
    function FeaturedCheckboxCheck(grid, element, checked)
    {
        checkBoxes.set(element.value, checked ? 1 : 0);

		$("in_featured_products").value = checkBoxes.toQueryString();
	   	grid.reloadParams = {"featured_ids": checkBoxes.toQueryString()};
    }
