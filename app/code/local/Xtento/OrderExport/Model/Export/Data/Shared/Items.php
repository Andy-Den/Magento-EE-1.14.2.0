 ...
 * Last Modified: 2014-11-07T19:51:55+01:00
...
class Xtento_OrderExport_Model_Export_Data_Shared_Items extends Xtento_OrderExport_Model_Export_Data_Abstract
{
        ...
        foreach ($items as $item) {
            ...
            if ($this->fieldLoadingRequired('parent_item') && $parentItem) {
                ...
                if ($this->fieldLoadingRequired('custom_options') && $options = $parentItem->getProductOptions()) {
                    $this->_writeCustomOptions($options, $this->_writeArray, $object);
                }
            ...
            if ($this->fieldLoadingRequired('custom_options') && $options = $item->getProductOptions()) {
                ...
                $this->_writeCustomOptions($options, $this->_origWriteArray, $object);
    ...
    private function _writeCustomOptions($options, &$writeArray, $object)
    {
                        ...
                        if ($values->count()) {
                            ...
                            if ($value->getOptionId() && $value->getSku()) {
                                ...
                                if (isset($customOption['option_id'])) {
                                    ...
                                    if (array_key_exists($buyRequestQtyKey, $options['info_buyRequest'])) {
