...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_stockimport_profile') . "` (
...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_stockimport_source') . "` (
...
CREATE TABLE IF NOT EXISTS `" . $this->getTable('xtento_stockimport_log') . "` (
