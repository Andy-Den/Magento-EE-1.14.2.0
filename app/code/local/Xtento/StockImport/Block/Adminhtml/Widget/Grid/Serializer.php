...
if (@class_exists('Mage_Adminhtml_Block_Widget_Grid_Serializer')) {
    if (!@class_exists('Xtento_StockImport_Block_Adminhtml_Widget_Grid_Serializer')) {
        class Xtento_StockImport_Block_Adminhtml_Widget_Grid_Serializer extends Mage_Adminhtml_Block_Widget_Grid_Serializer
        {
    ...
    if (!@class_exists('Xtento_StockImport_Block_Adminhtml_Widget_Grid_Serializer')) {
        class Xtento_StockImport_Block_Adminhtml_Widget_Grid_Serializer extends Mage_Core_Block_Template
        {
            ...
            {
                parent::_construct();
                $this->setTemplate('xtento/stockimport/widget/grid/serializer.phtml');
                return $this;
            }
