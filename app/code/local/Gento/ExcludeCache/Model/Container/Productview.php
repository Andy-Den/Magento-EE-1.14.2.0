...
class Gento_ExcludeCache_Model_Container_Productview extends Enterprise_PageCache_Model_Container_Abstract
{
    protected function _getCacheId()
    {
        return 'PRODUCT_VIEW' . md5($this->_placeholder->getAttribute('cache_id')).'_'.$this->_getIdentifier();
    }
