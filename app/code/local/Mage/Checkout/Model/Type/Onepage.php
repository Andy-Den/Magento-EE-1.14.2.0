    ...
    public function saveOrder()
    {
        ...
        if ($order) {
            ...
            if (!$redirectUrl && $order->getCanSendNewEmailFlag()) {
                try {
                   if($_SESSION["payment_method_checkout"]=="Internet Banking/ATM transfer") {

                        $order->sendNewOrderEmail();
                       $_SESSION["payment_method_checkout"] ="";
                    }
                    /*if($order->getPayment()->getMethodInstance()->getCode()=='settings_payments_standart'){
                        $order->sendNewOrderEmail();
