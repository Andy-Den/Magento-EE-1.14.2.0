...
class Gene_Braintree_Block_Creditcard extends Mage_Payment_Block_Form_Cc
{
     ...
     * @var Gene_Braintree_Model_Resource_Saved_Collection
     */
     ...
     * @return Gene_Braintree_Model_Resource_Saved_Collection
     */
    public function getSavedDetails()
    {
        if(!$this->_savedDetails) {
            $this->_savedDetails = Mage::getModel('gene_braintree/saved')->getSavedMethodsByType(Gene_Braintree_Model_Saved::SAVED_CREDITCARD_ID);
        }
