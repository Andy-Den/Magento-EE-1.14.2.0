                ...
                <td class="value">
                    ...
                    <div id="recent-version">
                        <div style="padding: 8px 0;line-height: 16px;">
                            <img src="' . $this->getSkinUrl('images/rule-ajax-loader.gif') . '" align="left" style="margin-right: 3px;" /> Checking latest version...
                        </div>
                    </div>
                </td>
            </tr>',
...
document.observe("dom:loaded", function() {
    try {
        new Ajax.Request("http://braintree.gene.co.uk/", {
